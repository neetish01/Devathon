...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2016 at 02:05 PM
...
(1, '', '', 90, 0000, '', '', 90, 0000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8.76, NULL, NULL, NULL);
...
(2, 'Facebook', 'http://www.facebook.com', 1, '2.png', 1, 'Facebook is social networking website');
...
INSERT INTO `company_status` (`visit_id`, `round_no`, `round_name`, `final`) VALUES
(1, 1, 'Aptitude', 0);
...
INSERT INTO `profile_lock` (`lock_date`) VALUES
('2016-03-31');
...
(1, '127.0.0.1', 'administrator', '$2y$08$5FX3b2ntXach5C2tiLM4HOH0ylmWwWIYj7.InxXDhxYf0.P8Zs8vK', '', 'admin@admin.com', '', 'bB7RCUiqfptWoCeTTIWV8ub4c31431d1c1f2fcfd', 1456091372, NULL, 1268889823, 1467460579, 1, 'Admin', 'istrator', '0');
...
CREATE TABLE `users_data` (
  ...
  `middle_name` varchar(40) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `skills` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `projects` text COLLATE utf8_unicode_ci NOT NULL,
  `experience` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `hobbies` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  ...
  `approved` int(2) NOT NULL COMMENT '0=not filled 1=approved 2=filled',
...
(1, 'Sreerag', 'M', 'Sreenath', '', '134153', '811371', 1, 1, '1995-09-21', 5, '', '9502812109', 'lol', 'lol', '', '', '', '', '', '', 0, '134153skfhf', 1, 3);
...
ALTER TABLE `company_status`
  ADD PRIMARY KEY (`visit_id`,`round_no`);
