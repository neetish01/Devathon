...
function csv_to_array($id){
 ...
 $this->upload_csv($excluded_result);
   ...
   function cod_help()
{
    $data=$this->cod_model->get_user_info();
	$this->_render_page('cod_help',$data);
}
	...
	function modify_company()
	{
		...
		$this->_render_page('modify_company',$data);
	}
	...
	function delete_company()
	{
		...
		$this->_render_page('delete_company',$data);
	}
	...
	function modify_visit()
	{
		...
		$this->_render_page('modify_visit',$data);
	}
	...
	function all_visits()
	{
		...
		$this->_render_page('all_visits',$data);	}
	...
	function get_branch_student_list()
	{
		$data['student']=$this->cod_model->branch_list();
		$this->_render_page("branch_list",$data);
	}
