		...
		<form id="visitform" method="post" action="<?php echo base_url('cod/add_visit')?>" onsubmit="return checkDates();">
			...
			<div class="row">
				<div class="col s12 m10 l8 offset-m1 offset-l2">
					...
					<hr>
					<blockquote>Select all options in <i>category</i> if all students are applicable..</blockquote>
					<blockquote>General does not mean <b>ALL</b> but is <i>category</i> specific.</blockquote>
				</div>
			</div>
			<div class="row">
