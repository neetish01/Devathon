        ...
        <div class="wrapper">
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class="bold"><a href="<?php echo base_url('/admin/deactivate_req') ?>" class="waves-effect waves-cyan"><i class="mdi-action-perm-device-info"></i>Deactivation Requests</a>
                    </li>
                    <li class="bold"><a href="<?php echo base_url('/admin/feedbacks') ?>" class="waves-effect waves-cyan"><i class="mdi-notification-mms"></i>Feedbacks</a>
                    </li>
                    <li class="no-padding">
