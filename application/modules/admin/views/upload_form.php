				...
				<table class="striped">
					...
					<tbody>
						<tr>
							...
							<td>Resume</td>
							<td><?php 
							if (file_exists('./assets/uploads/'.$roll_number.'/resume.pdf')) 
							{
								echo "Present";
							}
							else 
							...
							<tr>
								...
								<td><?php 
								if (file_exists('./assets/uploads/'.$roll_number.'/10th_cert.pdf')) 
								{
									echo "Present";
								}
								else 
								...
								<tr>
									...
									<td><?php 
									if (file_exists('./assets/uploads/'.$roll_number.'/12th_cert.pdf')) 
									{
										echo "Present";
									}
									else 
									...
									<tr>
										<td>4</td>
										<td>SC/ST</td>
										<td><?php if (file_exists('./assets/uploads/'.$roll_number.'/scst.pdf')) 
										{
											echo "Present";
										}
										else 
										...
										<tr>
											...
											<td>PWD</td>
											<td><?php 
											if (file_exists('./assets/uploads/'.$roll_number.'/pwd.pdf')) 
											{
												echo "Present";
											}
											else 
											...
											<tr>
												...
												<td><?php 
												if (file_exists('./assets/uploads/'.$roll_number.'/grad.pdf')) 
												{
													echo "Present";
												}
												else 
