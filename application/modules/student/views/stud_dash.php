...
<html lang="en">
	...
	<body>
		<ul id="option" class="dropdown-content ">
			...
			<li><a href="<?php echo base_url('student/stud_help')?>">Help</a>
			</li>
				...
				<aside id="left-sidebar-nav">
					<ul id="slide-out" class="side-nav fixed leftside-navigation">
							...
							<div class="row">
								<div class="col col s4 m4 l4">
									<a href="<?php echo base_url('student/upload/upload_photo')?>" style="display:inline;">
										<img src="<?php if (file_exists('./assets/stud_profile_pic/'.$user['encrypt'].$id.'.jpg')){echo base_url('./assets/stud_profile_pic/'.$user['encrypt'].$id.'.jpg');} else {echo base_url('assets/materialize/images/avatar.jpg');}?>" alt="" class="circle responsive-img valign profile-image">
									</a>
								</div>
								<div class="col col s8 m8 l8">
									...
									<p class="user-roal"><?php echo $user['roll_number'] ?> </p>
								</div>
							</div>
						</li>
						<li class="bold  <?php echo $current_page == "news" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/news_all')?>" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i>News</a>
						</li>
						<li class="bold <?php echo $current_page == "show_calender" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/show_calender')?>" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Calender</a>
						</li>
						<li class="bold <?php echo $current_page == "companies" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/companies');?>" class="waves-effect waves-cyan"><i class="mdi-communication-business"></i>Companies</a>
						</li>
						<li class="bold <?php echo $current_page == "feedback_list" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/feedback_list')?>" class="waves-effect waves-cyan"><i class="mdi-communication-chat"></i>Feedback</a>
						</li>
						<li class="bold <?php echo $current_page == "all_cod" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/all_coordinators') ?>" class="waves-effect waves-cyan"><i class="mdi-action-assignment-ind"></i> Co-ordinators</a>
                   		</li>
						<li class="no-padding ">
							<ul class="collapsible collapsible-accordion">
								<li class="bold "><a class="collapsible-header waves-effect waves-cyan <?php echo $current_page == "upload_files" ? "active" : '' ; ?>"><i class="mdi-file-folder-shared"></i>My Documents</a>
									<div class="collapsible-body">
										<ul>
											<li class="<?php echo $current_page == "upload_files" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/upload/upload_files')?>">Upload Documents</a>
											</li>
											<li class=""><a href="<?php echo base_url('/student/resume')?>">Auto Generate Resume</a>
											</li>
										</ul>
									</div>
								</li>
						...
						<li class="no-padding">
							<ul class="collapsible collapsible-accordion">
								<li class="bold">
									<a class="collapsible-header waves-effect waves-cyan <?php echo $current_page == "application_status" ? "active" : '' ; ?><?php echo $current_page == "new_application" ? "active" : '' ; ?>"><i class="mdi-action-assignment"></i> Apply </a>
									<div class="collapsible-body">
										<ul>
											<li class="<?php echo $current_page == "new_application" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/new_application')?>">New Application</a>
											</li>
											<li class="<?php echo $current_page == "application_status" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student/application_status')?>">Application Status</a>
											</li>
										</ul>
									</div>
								</li>
						...
						<li class="bold <?php echo $current_page == "rules" ? "active" : '' ; ?>"><a href="<?php echo base_url('/student')?>" class="waves-effect waves-cyan"><i class="mdi-alert-error"></i> Rules and Regulations</a>
						</li>
					</ul>
