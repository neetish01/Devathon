				...
				<table class="striped">
					...
					<tbody>
						<tr>
							...
							<td>Resume</td>
							<td><?php 
							if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_resume.pdf')) 
							{
								echo "Present";
							}
							else 
							...
							<tr>
								...
								<td><?php 
								if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_10th_cert.pdf')) 
								{
									echo "Present";
								}
								else 
								...
								<tr>
									...
									<td><?php 
									if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_12th_cert.pdf')) 
									{
										echo "Present";
									}
									else 
									...
									<tr>
										<td>4</td>
										<td>SC/ST</td>
										<td><?php if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_scst.pdf')) 
										{
											echo "Present";
										}
										else 
										...
										<tr>
											...
											<td>PWD</td>
											<td><?php 
											if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_pwd.pdf')) 
											{
												echo "Present";
											}
											else 
											...
											<tr>
												...
												<td><?php 
												if (file_exists('./assets/uploads/documents/'.$specialization_id.'/'.$encrypt.'/'.$roll_number.'_grad.pdf')) 
												{
													echo "Present";
												}
												else 
