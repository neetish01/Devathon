						...
						<li>
							...
							<div class="collapsible-body" style="">
								<p>Prof. G. Amba Prasada Rao, Professor Incharge<br>
									...
									<a href="tel:+91-9490165357">+91-9490165357(Mobile)</a><br>
									<a href="tel:+91-8332969315">+91-8332969315(Alternative)</a>
								</p>
							</div>
						</li>
						<li class="active">
							...
							<div class="collapsible-body" style="display: none;">
								<p>Dr. A. V. Giridhar<br>
									National Institute of Technology, Warangal<br>
									Telangana - 506 004<br>
									<a href="tel:+91 9490164796">+91 94901 64796 (Mobile)</a>
								</p>
							</div>
						</li>
						<li class="active">
							...
							<div class="collapsible-body" style="display: none;">
								<p>
									...
									<a href="mailto:taps@nitw.ac.in">Email: taps@nitw.ac.in</a><br>
									<a href="mailto:tapsnit.ac@gmail.com">Email: tapsnit.ac@gmail.com</a>
								</p>
							</div>
						</li>
					</ul>
