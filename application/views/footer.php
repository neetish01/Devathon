		...
		<footer class="blue page-footer">
			<div class="row">
				...
				<div class="col l4 offset-l2 s12 m3">
					...
					<ul>
						<li><a class="white-text" href="<?php echo base_url('/contact_us')?>">Contact Us</a></li>
						<li><a class="white-text" href="<?php echo base_url('/main/view/legal_disclaimer')?>">Legal Disclaimer</a></li>
						<li><a class="white-text" href="<?php echo base_url('/main/view/terms_of_use')?>">Terms of Use</a></li>
