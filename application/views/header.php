		...
		<header>
			<nav>
				<div class="blue nav-wrapper">
					...
					<a href="<?php echo base_url()?>" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
					<ul id="nav-mobile" class="right hide-on-med-and-down">
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Home">Home<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a href="<?php echo base_url('/main/view/academics')?>">Academic</a></li>
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Recruiters">Recruiters<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a class="dropdown-button"  data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Students">Students<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="team">The Team<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a href="<?php echo base_url('/main/contact_us')?>">Contact Us</a></li>
						<!-- <li><a href="<?php echo base_url('/auth/index') ?>">Login</a></li> -->
					</ul>
					<ul class="side-nav" id="mobile-demo">
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Home1">Home<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a href="<?php echo base_url('/main/view/academics')?>">Academic</a></li>
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Recruiters1">Recruiters<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a class="dropdown-button"  data-beloworigin="true" href="<?php echo base_url()?>" data-activates="Students1">Students<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a class="dropdown-button" data-beloworigin="true" href="<?php echo base_url()?>" data-activates="team1">The Team<i class="material-icons right">arrow_drop_down</i></a></li>
						<li><a href="<?php echo base_url('/main/contact_us')?>">Contact Us</a></li>
						<!-- <li><a href="<?php echo base_url('/auth/index') ?>">Login</a></li> -->
					</ul>
				</div>
			...
			<ul id="Recruiters" class="dropdown-content">
				...
				<li><a href="<?php echo base_url('/main/view/Brochure')?>">Brochure 16-17</a></li>
			...
			<ul id="Students" class="dropdown-content">
				...
				<li><a href="<?php echo base_url('/main/view/stats')?>">Placement Statistics</a></li>
			</ul>
